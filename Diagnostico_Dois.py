...
def funcao(lista):  # função para iterar sobre a lista sintomas
    for i in lista:
        print(f'Você apresenta {i}?')  # pergunta se a pessoa tem ou não determinado sintoma
        print('Responda S/N')
        positivo = input('>>> ')
...
for i in range(5, 37, 4):  # gerando os valores de i
    ...
    print('Voce possui mais sintomas?')
    confirm = input('>>> ')
...
if maior == porcentagem_asma and maior != 0:
    print("    Você apresenta sintomas de Asma, é fundamental procurar a unidade de sáude mais próxima"
    ...
    print("    Você apresenta sintomas de Covid_19, é fundamental procurar a unidade de sáude mais próxima "
          "da sua residencia para avaliação e realização de exames. Se o resultado der positivo, deve-se iniciar "
          "o tratamento o mais rápido possivel e segui-lo até o final.")
    ...
    print("    Você apresenta sintomas de Caxumba, é fundamental procurar a unidade de sáude mais próxima "
          "da sua residencia para avaliação e realização de exames. Se o resultado der positivo, deve-se iniciar"
          "o tratamento o mais rápido possivel e segui-lo até o final.")
    ...
    print("    Você apresenta sintomas de Chikungunya, é fundamental procurar a unidade de sáude mais próxima"
          "da sua residencia para avaliação e realização de exames. Se o resultado der positivo, deve-se iniciar"
          "o tratamento o mais rápido possivel e segui-lo até o final.")
    ...
    print("    Você apresenta sintomas de Gripe(influenza), é fundamental procurar a unidade de sáude mais próxima "
          "da sua residencia para avaliação e realização de exames. Se o resultado der positivo, deve-se iniciar "
          "o tratamento.")
    ...
    print("    Você apresenta sintomas de Dengue, é fundamental procurar a unidade de sáude mais próxima"
          "da sua residencia para avaliação e realização de exames. Se o resultado der positivo, deve-se iniciar"
          "o tratamento o mais rápido possivel e segui-lo até o final.")
    ...
    print("    Você apresenta sintomas de Tuberculose, é fundamental procurar a unidade de sáude mais próxima"
          "da sua residencia para avaliação e realização de exames. Se o resultado der positivo, deve-se iniciar"
          "o tratamento o mais rápido possivel e segui-lo até o final.")
    ...
    print("    Você apresenta sintomas de Hipertensão, é fundamental procurar a unidade de sáude mais próxima"
          "da sua residencia para avaliação e realização de exames. Se o resultado der positivo, deve-se iniciar"
          "o tratamento o mais rápido possivel e segui-lo até o final.")
    if len(diferenca_tuberculose) != 0:
    ...
    print('    Aparentemente você não apresenta nenhum sintoma, porem existem pacientes que mesmo estando com alguma doença, '
          'não apresentam sintomas, como é o caso do Covid-19. Caso tenha tido contado com, nos ultimos 14 dias com um caso'
          'diagnosticado com Covid_19, é fundamental procurar a unidade de sáude mais próxima'
          'da sua residencia para avaliação e realização de exames. Se o resultado der positivo, deve-se iniciar'
          'o tratamento o mais rápido possivel e segui-lo até o final.')

print('Caso queira saber mais sobre alguma doença digite: S/N')
n = input('>>> ')
